...
import { obtenerTodos, obtenerPorId, crear, actualizar, eliminar } from './notificacion.service.js'
...
export const getById = async (req, res) => {
  ...
  if (!item) return res.status(404).json({ mensaje: 'Notificacion no encontrado' })
  res.json(item)
}
...
export const remove = async (req, res) => {
  ...
  res.json({ mensaje: 'Notificacion eliminado correctamente' })
}

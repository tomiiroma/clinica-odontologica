...
import { obtenerTodos, obtenerPorId, crear, actualizar, eliminar } from './equipamiento.service.js'
...
export const getById = async (req, res) => {
  ...
  if (!item) return res.status(404).json({ mensaje: 'Equipamiento no encontrado' })
  res.json(item)
}
